...
pub fn audit_main() {
 ...
 for scenario in ["wrong_doh_template_and_fallback", "wrong_fallback_only", "off_still_on", "new_doh_rollback", "residual_global_doh", "dns_timeout", "dhcp_ipv6_only", "empty_static_preflight"] {
